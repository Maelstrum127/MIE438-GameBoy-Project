...
C:\gbdk\bin\lcc -Wa-l -Wl-m -Wf--debug -Wl-y -Wl-w -Wm-yc -Wl-j -Wl-yt0x01 -Wl-yo4 -o bits_adventure.gb Lvl1BackgroundMap.o Lvl1BackgroundData.o main.o GameSprites.o bank2.o bank3.o
