...
;--------------------------------------------------------
	.area _CODE
;main.c:127: void setup_windows(unsigned char *win_data, unsigned char *win_map, int data_size, unsigned int MapHeight, unsigned int MapWidth, unsigned int MapX, unsigned int MapY){
;	---------------------------------
; Function setup_windows
; ---------------------------------
_setup_windows::
;main.c:128: DISPLAY_OFF;
	call	_display_off
;main.c:129: set_win_data(0,data_size,win_data);
	ldhl	sp,	#6
	ld	a, (hl)
	pop	bc
	pop	hl
	...
	call	_set_win_data
	add	sp, #4
;main.c:130: set_win_tiles(0,0,MapWidth,MapHeight,win_map);
	ldhl	sp,	#8
	ld	a, (hl+)
	ld	d, a
	inc	hl
...
;main.c:134: DISPLAY_ON;
	...
	or	a, #0x80
	ldh	(_LCDC_REG+0),a
;main.c:135: waitpad(J_START);
	ld	a, #0x80
	push	af
	inc	sp
	call	_waitpad
	inc	sp
;main.c:136: waitpadup(); 
;main.c:137: }
	jp  _waitpadup
_blankmap3:
	.db #0x51	; 81	'Q'
...
_spritepalette:
	...
	.dw #0x000f
	.dw #0x0000
;main.c:139: void setup_splashscreen(){
;	---------------------------------
; Function setup_splashscreen
; ---------------------------------
_setup_splashscreen::
;main.c:140: setup_windows(Letter2Data, Intro1Map, 40, Intro1MapHeight, Intro1MapWidth, 7, 7);
	ld	hl, #0x0007
	push	hl
	ld	l, #0x07
	push	hl
	...
	call	_setup_windows
	add	sp, #14
;main.c:141: setup_windows(Letter2Data, Intro2Map, 40, Intro2MapHeight, Intro2MapWidth, 7, 7);
	ld	hl, #0x0007
	push	hl
	ld	l, #0x07
	push	hl
	...
	call	_setup_windows
	add	sp, #14
;main.c:142: setup_windows(Letter2Data, Intro3Map, 40, Intro3MapHeight, Intro3MapWidth, 7, 7);
	ld	hl, #0x0007
	push	hl
	ld	l, #0x07
	push	hl
...
;main.c:144: }
	ret
;main.c:146: void setup_dialogues(){
;	---------------------------------
; Function setup_dialogues
; ---------------------------------
_setup_dialogues::
;main.c:147: setup_windows(Letter2Data, Diag1, 41, Diag1Height, Diag1Width, 7, 104);
	ld	hl, #0x0068
	push	hl
	ld	l, #0x07
	push	hl
	...
	call	_setup_windows
	add	sp, #14
;main.c:148: setup_windows(Letter2Data, Diag2, 41, Diag2Height, Diag2Width, 7, 104);
	ld	hl, #0x0068
	push	hl
	ld	l, #0x07
	push	hl
	...
	call	_setup_windows
	add	sp, #14
;main.c:149: setup_windows(Letter2Data, Diag3, 41, Diag3Height, Diag3Width, 7, 104);
	ld	hl, #0x0068
	push	hl
	ld	l, #0x07
	push	hl
	...
	call	_setup_windows
	add	sp, #14
;main.c:150: setup_windows(Letter2Data, Diag4, 41, Diag4Height, Diag4Width, 7, 104);
	ld	hl, #0x0068
	push	hl
	ld	l, #0x07
	push	hl
...
;main.c:152: }
	ret
;main.c:154: void setup_map(UWORD *pallete, unsigned char *map_data, unsigned char *tiles_1, unsigned char *tiles_0, int data_size, unsigned int MapHeight, unsigned int MapWidth){
;	---------------------------------
; Function setup_map
; ---------------------------------
_setup_map::
;main.c:156: DISPLAY_OFF;
	call	_display_off
;main.c:157: set_bkg_palette(0, 8, pallete);
	pop	bc
	pop	hl
	push	hl
	push	bc
	...
	add	sp, #4
;main.c:158: set_bkg_data(0, data_size, map_data);
	ldhl	sp,	#10
	ld	b, (hl)
	ldhl	sp,	#4
	ld	a, (hl+)
	...
	call	_set_bkg_data
	add	sp, #4
;main.c:159: VBK_REG = 1;
	ld	a, #0x01
	ldh	(_VBK_REG+0),a
;main.c:160: set_bkg_tiles(0, 0, MapWidth, MapHeight, tiles_1);
	ldhl	sp,	#12
	ld	a, (hl+)
	ld	b, a
	inc	hl
	...
	call	_set_bkg_tiles
	add	sp, #6
;main.c:161: VBK_REG = 0;
	ld	a, #0x00
	ldh	(_VBK_REG+0),a
;main.c:162: set_bkg_tiles(0, 0, MapWidth, MapHeight, tiles_0);
	ldhl	sp,	#8
	ld	a, (hl+)
	ld	h, (hl)
	ld	l, a
...
;main.c:168: }
	ret
;main.c:170: void setup_characters(int character_x, int character_y){
;	---------------------------------
; Function setup_characters
; ---------------------------------
_setup_characters::
;main.c:171: set_sprite_palette(0,8, &spritepalette[0]);
	...
	add	sp, #4
;main.c:172: set_sprite_data(0, 46, GameSprites);
	ld	hl, #_GameSprites
	push	hl
	ld	a, #0x2e
	push	af
	...
	add	sp, #4
;main.c:173: setupbit(character_x, character_y);
	ldhl	sp,	#4
	ld	a, (hl-)
	dec	hl
	ld	b, (hl)
	...
	call	_setupbit
	add	sp, #2
;main.c:174: player_location[0] = character_x;
	...
	ld	a, (hl)
	ld	(de), a
;main.c:175: player_location[1] = character_y;
	...
	ld	a, (hl)
	ld	(de), a
;main.c:176: SHOW_SPRITES;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x02
	ldh	(_LCDC_REG+0),a
;main.c:177: }
	ret
;main.c:180: void scroll_frog(int x, int y){
;	---------------------------------
; Function scroll_frog
; ---------------------------------
_scroll_frog::
	add	sp, #-3
;main.c:181: scroll_sprite(frog.spriteids[0], x, y);
	ldhl	sp,	#7
	ld	c, (hl)
	ldhl	sp,	#0
	ld	(hl), c
...
;C:/gbdk/include/gb/gb.h:1094: itm->y+=y, itm->x+=x;
	...
	add	a, (hl)
	ld	(de), a
;main.c:182: scroll_sprite(frog.spriteids[1], x, y);
	ld	hl, #_frog + 1
;C:/gbdk/include/gb/gb.h:1093: OAM_item_t * itm = &shadow_OAM[nb];
	ld	l, (hl)
	ld	de, #_shadow_OAM+0
...
;C:/gbdk/include/gb/gb.h:1094: itm->y+=y, itm->x+=x;
	...
	add	a, (hl)
	ld	(de), a
;main.c:183: scroll_sprite(frog.spriteids[2], x, y);
	ld	hl, #_frog + 2
;C:/gbdk/include/gb/gb.h:1093: OAM_item_t * itm = &shadow_OAM[nb];
	ld	l, (hl)
	ld	de, #_shadow_OAM+0
...
;C:/gbdk/include/gb/gb.h:1094: itm->y+=y, itm->x+=x;
	...
	add	a, (hl)
	ld	(de), a
;main.c:184: scroll_sprite(frog.spriteids[3], x, y);
	ld	hl, #_frog + 3
;C:/gbdk/include/gb/gb.h:1093: OAM_item_t * itm = &shadow_OAM[nb];
	ld	l, (hl)
	ld	de, #_shadow_OAM+0
...
;main.c:185: }
	add	sp, #3
	ret
;main.c:187: _Bool levelPongOne(UINT8 *step){
;	---------------------------------
; Function levelPongOne
; ---------------------------------
_levelPongOne::
	add	sp, #-4
;main.c:188: SWITCH_ROM_MBC1(2);
	ld	a, #0x02
	ldh	(__current_bank+0),a
	ld	hl, #0x2000
	ld	(hl), #0x02
;main.c:189: struct GameCharacter* bitAddress = returnBitAddress();
	call	_returnBitAddress
	inc	sp
	inc	sp
	push	de
;main.c:191: setupbit(80, 130);
	ld	de, #0x8250
	push	de
	call	_setupbit
	add	sp, #2
;main.c:192: setupBitPong();
	call	_setupBitPong
;main.c:193: DISPLAY_OFF;
	call	_display_off
;main.c:194: set_bkg_palette(0,7,&blankbackground[0]);
	...
	call	_set_bkg_palette
	add	sp, #4
;main.c:195: wait_vbl_done();
	call	_wait_vbl_done
;main.c:196: SHOW_BKG;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x01
	ldh	(_LCDC_REG+0),a
;main.c:197: DISPLAY_ON;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x80
	ldh	(_LCDC_REG+0),a
;main.c:201: for (i=0; i<3; i++){   
	ld	b, #0x00
00128$:
;main.c:202: tileid = i*2 + 6;
	ld	a, b
	add	a, a
	add	a, #0x06
	ld	c, a
;main.c:204: SWITCH_ROM_MBC1(4);
	ld	a, #0x04
	ldh	(__current_bank+0),a
	ld	hl, #0x2000
	ld	(hl), #0x04
;C:/gbdk/include/gb/gb.h:1004: shadow_OAM[nb].tile=tile;
	...
	ld	a,h
	ld	(hl), #0x2a
;main.c:206: set_sprite_tile(tileid+1, 43);
	ld	e, c
	inc	e
;C:/gbdk/include/gb/gb.h:1004: shadow_OAM[nb].tile=tile;
	xor	a, a
	...
	inc	hl
	ld	(hl), #0x2b
;main.c:208: SWITCH_ROM_MBC1(3);
	ld	a, #0x03
	ldh	(__current_bank+0),a
	ld	hl, #0x2000
	ld	(hl), #0x03
;main.c:209: setupenemiesPongOne(i);
	push	bc
	push	bc
	inc	sp
	...
	inc	sp
	pop	bc
;main.c:210: pongOnePartOne(i, tileid);
	push	bc
	ld	a, c
	push	af
	inc	sp
	...
	add	sp, #2
	pop	bc
;main.c:211: movePongCharacterFromCombatLevelsFile(i);
	push	bc
	push	bc
	inc	sp
...
;main.c:214: ballID = 3;
	ld	hl, #_ballID
	ld	(hl), #0x03
;main.c:215: setupball(ballID);
	ld	a, #0x03
	push	af
	inc	sp
	call	_setupball
	inc	sp
;main.c:217: SHOW_SPRITES;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x02
	ldh	(_LCDC_REG+0),a
;main.c:218: DISPLAY_ON;
	...
	or	a, #0x80
	ldh	(_LCDC_REG+0),a
;main.c:222: bitLives = 3;
	ld	hl, #_bitLives
	ld	(hl), #0x03
;main.c:223: enemyLives = 3;
	ld	hl, #_enemyLives
	ld	(hl), #0x03
;main.c:225: while(bitLives != 0 && enemyLives != 0){
	ldhl	sp,	#6
	ld	a, (hl+)
	ld	e, (hl)
	ldhl	sp,	#2
...
00114$:
	...
	or	a, a
	jp	Z, 00116$
;main.c:226: for (timer = 0; timer<8; timer++){
	ld	c, #0x00
00130$:
;main.c:227: performantdelay(250); 
	push	bc
	ld	a, #0xfa
	push	af
	inc	sp
...
;main.c:226: for (timer = 0; timer<8; timer++){
	...
	sub	a, #0x08
	jr	C, 00130$
;main.c:230: SWITCH_ROM_MBC1(2);
	ld	a, #0x02
	ldh	(__current_bank+0),a
	ld	hl, #0x2000
	ld	(hl), #0x02
;main.c:231: if(joypad()){
	call	_joypad
	ld	a, e
	or	a, a
	jr	Z, 00104$
;main.c:232: pongJoypadDetection(step);
	pop	bc
	pop	hl
	push	hl
	push	bc
	...
	jr	00105$
00104$:
;main.c:235: wastetest = setbit_forward(*step);
	ldhl	sp,#2
	ld	a, (hl+)
	ld	e, a
	ld	d, (hl)
	...
	inc	sp
00105$:
;main.c:238: SWITCH_ROM_MBC1(3);
	ld	a, #0x03
	ldh	(__current_bank+0),a
	ld	hl, #0x2000
	ld	(hl), #0x03
;main.c:240: PongOnecheckcollisions(bitAddress, ballID);
	ld	a, (#_ballID)
	push	af
	inc	sp
	ldhl	sp,	#1
	...
	add	sp, #3
;main.c:242: wastetest = pongOneUpdate(&bitLives, &enemyLives, ballID);
	ld	a, (#_ballID)
	push	af
	inc	sp
	ld	hl, #_enemyLives
	...
	add	sp, #5
	ld	a, e
;main.c:244: if (wastetest == 0 && bitLives != 0 && enemyLives != 0){
	or	a, a
	jr	NZ, 00114$
	ld	a, (#_bitLives)
	or	a, a
	...
	or	a, a
	jp	Z, 00114$
;main.c:245: setupball(ballID);
	ld	a, (#_ballID)
	push	af
	inc	sp
	call	_setupball
	inc	sp
;main.c:247: SHOW_SPRITES;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x02
	ldh	(_LCDC_REG+0),a
;main.c:248: DISPLAY_ON;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x80
	ldh	(_LCDC_REG+0),a
;main.c:250: performantdelay(100);        
	ld	a, #0x64
	push	af
	inc	sp
	call	_performantdelay
...
;main.c:253: printf("  Your lives: %d\n  Enemy lives: %d\n  Use A to continue", bitLives, enemyLives);
	...
	call	_printf
	add	sp, #6
;main.c:254: while(!(joypad() & J_START)){
00106$:
	call	_joypad
	ld	a, e
	rlca
	jr	C, 00108$
;main.c:255: performantdelay(5);
	ld	a, #0x05
	push	af
	inc	sp
	call	_performantdelay
...
;main.c:264: gotoxy(0, 7);
	...
	call	_gotoxy
	add	sp, #2
;main.c:265: printf("  === YOU LOSE ===\n   Please press B \n   to try again.");
	ld	hl, #___str_2
	push	hl
	call	_printf
	add	sp, #2
;main.c:266: while(!(joypad() & J_START)){
00117$:
	call	_joypad
	ld	a, e
	rlca
	jr	C, 00119$
;main.c:267: performantdelay(5); 
	ld	a, #0x05
	push	af
	inc	sp
	call	_performantdelay
...
;main.c:274: gotoxy(0, 7);
	...
	call	_gotoxy
	add	sp, #2
;main.c:275: printf("  YOU WON THE BATTLE!\n   Please press B \n    to continue.");
	ld	hl, #___str_3
	push	hl
	call	_printf
	add	sp, #2
;main.c:276: while(!(joypad() & J_START)){
00120$:
	call	_joypad
	ld	a, e
	rlca
	jr	C, 00122$
;main.c:277: performantdelay(5); 
	ld	a, #0x05
	push	af
	inc	sp
	call	_performantdelay
...
___str_3:
	...
	.ascii "    to continue."
	.db 0x00
;main.c:284: void main()
;	---------------------------------
; Function main
; ---------------------------------
_main::
	dec	sp
;main.c:286: unsigned char* bk_collision = Lvl1BackgroundMapPLN0;
;main.c:287: unsigned char* bk_tiles = Lvl1BackgroundMapPLN1;
;main.c:291: ENABLE_RAM_MBC1;
	ld	hl, #0x0000
	ld	(hl), #0x0a
;main.c:292: SWITCH_ROM_MBC1(0);
	ld	a, #0x00
	ldh	(__current_bank+0),a
	ld	h, #0x20
	ld	(hl), #0x00
;main.c:293: setup_splashscreen();
	call	_setup_splashscreen
;main.c:295: SWITCH_ROM_MBC1(4);
	ld	a, #0x04
	ldh	(__current_bank+0),a
	ld	hl, #0x2000
	ld	(hl), #0x04
;main.c:297: setupfrog();
	call	_setupfrog
;main.c:299: SWITCH_ROM_MBC1(2);
	ld	a, #0x02
	ldh	(__current_bank+0),a
	ld	hl, #0x2000
	ld	(hl), #0x02
;main.c:300: setup_map(backgroundpalette, Lvl1BackgroundData, bk_tiles, bk_collision, 127, MapHeight, MapWidth);
	ld	hl, #0x0017
	push	hl
	ld	l, #0x14
	push	hl
	...
	call	_setup_map
	add	sp, #14
;main.c:301: setup_characters(88, 88);
	ld	hl, #0x0058
	push	hl
	ld	l, #0x58
	push	hl
	...
	add	sp, #4
;main.c:302: do_game_play(bk_collision, MapHeight, MapWidth);
	ld	hl, #0x0017
	push	hl
	ld	l, #0x14
	push	hl
	...
	call	_do_game_play
	add	sp, #6
;main.c:304: SWITCH_ROM_MBC1(0);
	ld	a, #0x00
	ldh	(__current_bank+0),a
	ld	hl, #0x2000
	ld	(hl), #0x00
;main.c:305: setup_dialogues();
	call	_setup_dialogues
;main.c:307: SWITCH_ROM_MBC1(2);
	ld	a, #0x02
	ldh	(__current_bank+0),a
	ld	hl, #0x2000
	ld	(hl), #0x02
;main.c:308: do_game_play(bk_collision, MapHeight, MapWidth);
	ld	hl, #0x0017
	push	hl
	ld	l, #0x14
	push	hl
	...
	call	_do_game_play
	add	sp, #6
;main.c:310: performantdelay(5);
	ld	a, #0x05
	push	af
	inc	sp
	call	_performantdelay
	inc	sp
;main.c:313: UINT8 step = 0;
	xor	a, a
	ldhl	sp,	#0
	ld	(hl), a
;main.c:314: _Bool test = false;
	ld	e, #0x00
;main.c:315: while(test == false){
00101$:
	bit	0, e
	jr	NZ, 00104$
;main.c:316: test = levelPongOne(&step);
	ldhl	sp,	#0
	push	hl
	call	_levelPongOne
	add	sp, #2
